    ...
    <div>
      ...
      <div className="mt-8 flex justify-center">
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen((v) => !v)}
          className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-6 py-3 text-sm font-medium text-fg transition-colors hover:border-primary/50 hover:text-primary"
        >
          {open ? "옵션 접기" : "전체 옵션 보기"}
