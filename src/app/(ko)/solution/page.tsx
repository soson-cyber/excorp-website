...
const problems = [
  {
    no: "01",
    cat: "Market",
    title: "장비마다 다른 규격, 파편화된 XR 제작 환경",
    desc: "카메라·트래커·렌더·송출이 제각각이라, 연동과 동기화에 매번 시간이 듭니다.",
  },
  {
    no: "02",
    cat: "Pain Point",
    title: "도입 뒤에도 이어지는 운영·지원의 장벽",
    desc: "해외 솔루션은 영어 매뉴얼과 본사 시차로 대응이 늦고, 구축 후 직접 운영할 교육과 지원이 부족합니다.",
  },
  {
    no: "03",
    cat: "Opportunity",
    title: "실시간 XR 기술의 성숙, 통합 운영의 가능성",
    desc: "실시간 렌더링·트래킹 기술이 성숙하면서, 흩어진 장비를 하나의 흐름으로 운영하는 방식이 가능해졌습니다.",
  },
];

// 세그먼트 슬롯 (§0-C) — XR 솔루션이 맞는 곳.
const segments = [
  { id: "seg-broadcast", tag: "방송 · 중계", d: "생중계에 실시간 XR·AR 그래픽을 더해야 하는 방송사·중계 프로덕션." },
  { id: "seg-enterprise", tag: "기업 · 커머스", d: "세트 교체 없이 IR·웨비나·라이브커머스를 자체 무대에서 반복 운영하려는 기업." },
  { id: "seg-education", tag: "대학 · 교육", d: "버추얼 프로덕션을 직접 가르치고 실습 환경을 갖추려는 교육기관." },
];
