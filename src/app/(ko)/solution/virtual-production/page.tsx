...
const problems = [
  {
    no: "01",
    cat: "Market",
    title: "세트 제작 중심의 기존 영상 제작 방식",
    desc: "촬영마다 세트를 짓고 허무는 방식은 시간·공간의 제약이 크고, 배경을 바꾸려면 다시 지어야 합니다.",
  },
  {
    no: "02",
    cat: "Pain Point",
    title: "막막한 시작, 가늠하기 어려운 구성",
    desc: "장비·소프트웨어 정보가 흩어져 있어 필요한 구성과 규모를 정하기 어렵고, 합성 결과를 현장에서 보지 못하면 후반에서야 문제를 발견합니다.",
  },
  {
    no: "03",
    cat: "Opportunity",
    title: "촬영과 동시에 완성되는 실시간 합성",
    desc: "실시간 합성·트래킹 기술의 발전으로, 가상 배경 위에서 촬영하고 현장에서 바로 확인·완성하는 제작이 가능해졌습니다.",
  },
];
