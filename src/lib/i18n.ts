...
export const ui: Record<Locale, UiStrings> = {
  ko: {
    ...
    navFeatured: {
      Solution: { eyebrow: "EX ORIGINAL", title: "EXLINK", desc: "현실과 가상을 실시간으로 잇는 통합 XR 솔루션", cta: "솔루션 보기" },
  ...
  en: {
    ...
    footerRights: "All rights reserved.",
    navDesc: {
      "/solution/xr-solution": "EXLINK: an integrated XR solution that links the physical and virtual in real time",
    ...
    navFeatured: {
      Solution: { eyebrow: "EX ORIGINAL", title: "EXLINK", desc: "An integrated XR solution that links the real and virtual in real time", cta: "Explore the solution" },
