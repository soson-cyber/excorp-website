...
| redesign-director | general-purpose | ex-redesign | 전면 리디자인 프로그램(감사→전략→3안→상세설계) 디렉팅 |
...
> **전면 리디자인:** "리디자인/재설계/디자인 방향·시안/IA 재검토" 요청은 `ex-redesign` 스킬(redesign-director)로 라우팅한다. 리디자인 Phase 4 산출물(개발 전달 문서)이 나오면 이 오케스트레이터의 표준 워크플로우로 구현한다. 카피 거버넌스는 `ex-redesign/references/copy-governance.md`가 우선.
